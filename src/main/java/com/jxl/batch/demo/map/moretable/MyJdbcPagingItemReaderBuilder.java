 ...
 */
public class MyJdbcPagingItemReaderBuilder<T> {
	 ...
	 */
	public MyJdbcPagingItemReaderBuilder<T> saveState(boolean saveState) {
	 ...
	 */
	public MyJdbcPagingItemReaderBuilder<T> name(String name) {
		this.name = name;
	 ...
	 */
	public MyJdbcPagingItemReaderBuilder<T> maxItemCount(int maxItemCount) {
	 ...
	 */
	public MyJdbcPagingItemReaderBuilder<T> currentItemCount(int currentItemCount) {
	 ...
	 */
	public MyJdbcPagingItemReaderBuilder<T> dataSource(DataSource dataSource) {
	 ...
	 */
	public MyJdbcPagingItemReaderBuilder<T> fetchSize(int fetchSize) {
	 ...
	 */
	public MyJdbcPagingItemReaderBuilder<T> rowMapper(RowMapper<T> rowMapper) {
	 ...
	 */
	public MyJdbcPagingItemReaderBuilder<T> parameterValues(Map<String, Object> parameterValues) {
	 ...
	 */
	public MyJdbcPagingItemReaderBuilder<T> pageSize(int pageSize) {
	 ...
	 */
	public MyJdbcPagingItemReaderBuilder<T> groupClause(String groupClause) {
	 ...
	 */
	public MyJdbcPagingItemReaderBuilder<T> selectClause(String selectClause) {
	 ...
	 */
	public MyJdbcPagingItemReaderBuilder<T> fromClause(String fromClause) {
	 ...
	 */
	public MyJdbcPagingItemReaderBuilder<T> whereClause(String whereClause) {
	 ...
	 */
	public MyJdbcPagingItemReaderBuilder<T> sortKeys(Map<String, Order> sortKeys) {
	 ...
	 */
	public MyJdbcPagingItemReaderBuilder<T> queryProvider(PagingQueryProvider provider) {
	 ...
	 */
	public MyJdbcPagingItemReader<T> build() {
		...
		MyJdbcPagingItemReader<T> reader = new MyJdbcPagingItemReader<>();
