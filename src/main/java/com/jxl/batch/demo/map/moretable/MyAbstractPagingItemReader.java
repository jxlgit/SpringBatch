 ...
 * @since 2.0
 */
public abstract class MyAbstractPagingItemReader<T> extends AbstractItemCountingItemStreamItemReader<T> 
	...
	public MyAbstractPagingItemReader() {
		setName(ClassUtils.getShortName(MyAbstractPagingItemReader.class));
	}
